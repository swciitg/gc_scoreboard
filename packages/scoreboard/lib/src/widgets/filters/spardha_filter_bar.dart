          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Visibility(
                  visible:
                      spardhaStore.selectedDate.isNotEmpty ? true : false, // date selected or not
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(color: Themes.primaryColor, width: 1.5),
                            ...
                            children: [
                              Text(
                                spardhaStore.selectedDate.isNotEmpty
                                    ? DateFormat(
                                      'dd-MMM-yyyy',
                                    ).format(DateTime.parse(spardhaStore.selectedDate))
                                    : '',
                              ...
                              SizedBox(
                                ...
                                child: IconButton(
                                  ...
                                  icon: Icon(Icons.clear, color: Themes.primaryColor),
                                  iconSize: 16,
                                ),
                              ),
                            ],
