...
class _StandingBoardState extends State<StandingBoard> {
  final _colorMedal = [0xffFFC907, 0xffD0DBDD, 0xffF07E48];
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child:
          widget.hostelStandings.isEmpty
              ? Center(child: Text("No Standings found", softWrap: true, style: fontStyle1))
              : ListView.separated(
                itemCount:
                    widget.hostelStandings.length + 1, //give length of content + 1 for heading
                itemBuilder: (context, index) {
                  if (index == 0) {
                    return Container(
                      ...
                      child: Row(
                        children: [
                          Expanded(flex: 1, child: Text('Position', style: standingStyle1)),
